...
<html>
    ...
    <body>
        ...
        <?php 
            ...
            $patientUsr = mysqli_query($con, "SELECT PatientID FROM PatientID WHERE Email='" . $user . "'");
            ...
            $patientPW = mysqli_query($con, "SELECT PassWord FROM PatientID WHERE Email='" . $user . "'");
